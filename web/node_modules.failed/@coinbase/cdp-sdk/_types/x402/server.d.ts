 ...
 */
export declare const CDP_SERVER_DEFAULT_EVM_NETWORKS: readonly ["eip155:8453"];
/**
 * Default Solana networks (production) — Solana mainnet.
 */
export declare const CDP_SERVER_DEFAULT_SVM_NETWORKS: readonly ["solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp"];
/**
 * Default networks for production: Base mainnet + Solana mainnet.
 */
export declare const CDP_SERVER_DEFAULT_NETWORKS: readonly string[];
/**
 * Default EVM networks for development — Base Sepolia (`eip155:84532`).
 */
export declare const CDP_SERVER_DEVELOPMENT_EVM_NETWORKS: readonly ["eip155:84532"];
/**
 * Default Solana networks for development — Solana Devnet.
 */
export declare const CDP_SERVER_DEVELOPMENT_SVM_NETWORKS: readonly ["solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1"];
/**
 * Default networks for development: Base Sepolia + Solana Devnet.
 */
export declare const CDP_SERVER_DEVELOPMENT_NETWORKS: readonly string[];
/**
 ...
 */
export declare class X402Server extends x402HTTPResourceServer {
    /**
 ...
 * ```
 */
export declare function createX402Server(config: CdpX402ServerConfig): Promise<X402Server>;
