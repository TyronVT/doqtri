...
import { baseMainnetCaip2, baseSepoliaCaip2, solanaMainnetCaip2, solanaDevnetCaip2, } from "./constants.js";
import { createCdpFacilitatorClient } from "./facilitator.js";
import { getCdpDefaultSchemes, getCdpBatchSettlementScheme, getCdpExtensionRegistrations, CDP_SUPPORTED_EXTENSIONS, CDP_EXTENSION_BAZAAR, buildBazaarDeclaration, } from "./server-extensions.js";
 ...
 */
export const CDP_SERVER_DEFAULT_EVM_NETWORKS = [baseMainnetCaip2];
/**
 * Default Solana networks (production) — Solana mainnet.
 */
export const CDP_SERVER_DEFAULT_SVM_NETWORKS = [solanaMainnetCaip2];
/**
 * Default networks for production: Base mainnet + Solana mainnet.
 */
export const CDP_SERVER_DEFAULT_NETWORKS = [
 ...
 */
export const CDP_SERVER_DEVELOPMENT_EVM_NETWORKS = [baseSepoliaCaip2];
/**
 * Default Solana networks for development — Solana Devnet.
 */
export const CDP_SERVER_DEVELOPMENT_SVM_NETWORKS = [solanaDevnetCaip2];
/**
 * Default networks for development: Base Sepolia + Solana Devnet.
 */
export const CDP_SERVER_DEVELOPMENT_NETWORKS = [
 ...
 * ```
 */
export async function createX402Server(config) {
