 ...
 */
export const CDP_EXTENSION_GAS_SPONSORING_EIP2612 = "eip2612GasSponsoring";
/**
 ...
 */
export const CDP_EXTENSION_GAS_SPONSORING_ERC20_APPROVAL = "erc20ApprovalGasSponsoring";
/**
 ...
 */
export const CDP_EXTENSION_BAZAAR = "bazaar";
/*
 * ---------------------------------------------------------------------------
 ...
 */
export const CDP_SUPPORTED_EXTENSIONS = {
 ...
 */
export function buildBazaarDeclaration(method, path) {
 ...
 */
export function getCdpDefaultSchemes() {
    return [
        { network: "eip155:*", server: new ExactEvmScheme() },
        { network: "eip155:*", server: new UptoEvmScheme() },
 ...
 */
export function getCdpBatchSettlementScheme(evmAddress) {
    return {
        network: "eip155:*",
 ...
 */
export function getCdpExtensionRegistrations() {
    return [
        {
