...
exports.CDP_SUPPORTED_EXTENSIONS = exports.CDP_EXTENSION_BAZAAR = exports.CDP_EXTENSION_GAS_SPONSORING_ERC20_APPROVAL = exports.CDP_EXTENSION_GAS_SPONSORING_EIP2612 = void 0;
exports.buildBazaarDeclaration = buildBazaarDeclaration;
exports.getCdpDefaultSchemes = getCdpDefaultSchemes;
exports.getCdpBatchSettlementScheme = getCdpBatchSettlementScheme;
exports.getCdpExtensionRegistrations = getCdpExtensionRegistrations;
const server_1 = require("@x402/evm/batch-settlement/server");
const server_2 = require("@x402/evm/exact/server");
const server_3 = require("@x402/evm/upto/server");
const bazaar_1 = require("@x402/extensions/bazaar");
const server_4 = require("@x402/svm/exact/server");
/*
 * ---------------------------------------------------------------------------
 ...
 */
exports.CDP_EXTENSION_GAS_SPONSORING_EIP2612 = "eip2612GasSponsoring";
/**
 ...
 */
exports.CDP_EXTENSION_GAS_SPONSORING_ERC20_APPROVAL = "erc20ApprovalGasSponsoring";
/**
 ...
 */
exports.CDP_EXTENSION_BAZAAR = "bazaar";
/*
 * ---------------------------------------------------------------------------
 ...
 */
exports.CDP_SUPPORTED_EXTENSIONS = {
    [exports.CDP_EXTENSION_GAS_SPONSORING_EIP2612]: {},
    [exports.CDP_EXTENSION_GAS_SPONSORING_ERC20_APPROVAL]: {},
};
/*
 * ---------------------------------------------------------------------------
 ...
 */
function buildBazaarDeclaration(method, path) {
 ...
 */
function getCdpDefaultSchemes() {
    return [
        { network: "eip155:*", server: new server_2.ExactEvmScheme() },
        { network: "eip155:*", server: new server_3.UptoEvmScheme() },
        { network: "solana:*", server: new server_4.ExactSvmScheme() },
    ];
}
/**
 ...
 */
function getCdpBatchSettlementScheme(evmAddress) {
    return {
        network: "eip155:*",
        server: new server_1.BatchSettlementEvmScheme(evmAddress),
    };
}
/*
 * ---------------------------------------------------------------------------
 ...
 */
function getCdpExtensionRegistrations() {
    return [
        {
            key: exports.CDP_EXTENSION_GAS_SPONSORING_EIP2612,
            enrichPaymentRequiredResponse: async (declaration) => declaration ?? {},
        },
        {
            key: exports.CDP_EXTENSION_GAS_SPONSORING_ERC20_APPROVAL,
            enrichPaymentRequiredResponse: async (declaration) => declaration ?? {},
        },
        bazaar_1.bazaarResourceServerExtension,
    ];
}
